  ...
  class Program
  {
    static void Main(string[] args)
    {
      ...
      Write("\n\n");
        ...
        /* Demonstrating Project Requirement 4 */
      "Testing Edit Value (REQUIREMENT 4)".title();

            DBElement<int, string> elem11 = new DBElement<int, string>();
            elem11.name = "elem11";
            elem11.descr = "replacing existing value's instance with new instance";
            elem11.payload = "requirement 4";
            db.replaceValue(1, elem11);
            db.show<int, DBElement<int, string>, string>();

            //Edit element via ItemEditor
            //ItemEditor<int, string> itemEditor = new ItemEditor<int, string>();         //This item editor edits strings

            Write("\nAfter ItemEditor Edit...\n\n\n");
            //itemEditor.editName(elem11, "item editor's new Name");                     //edit name
            //itemEditor.editDescription(elem11, "item editor's new Description");       //edit description
            //edit payload
            //edit timestamp
            //edit children list
            db.show<int, DBElement<int, string>, string>();
