 ...
 * Recently added support for DBFactory instances as well.
 */
/*
 * Maintenance:
 * ------------
 ...
 * --------------------
 * ver 1.3 :  7 Oct 15
 * - included show() method for DBFactory (Q's Code)
 * ver 1.2 : 24 Sep 15
...
namespace Project2Starter
{
  ...
  public static class DBEngineExtensions
  {
    ...
    //Show Method for DBFactory
    public static void show<Key, Value, Data>(this DBFactory<Key, Value> df)     //Q's CODE
        {
        Console.Write("\n\n DBFactory\n....................... \n");
        foreach (Key key in df.Keys())
        {
            Value value = df.getValue(key);
